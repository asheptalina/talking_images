            ...
            Circle()
                ...
                .gesture(
                    DragGesture()
                        ...
                        .onEnded { _ in
                            self.topLeftPoint.x += self.offset.width
                            self.topLeftPoint.y += self.offset.height

                            self.bottomLeftPoint.x += self.offset.width
                            self.topRightPoint.y += self.offset.height
